...
extension Color {
    // Primary Colors - Fixed colors that don't change
    ...
    static let textPrimary = Color.primary          // Black in light, white in dark
    static let textSecondary = Color.secondary      // Gray that adapts
    static let textTertiary = Color(.tertiaryLabel) // Lighter gray that adapts

    // Legacy neutral colors mapped to adaptive colors
    ...
    static let neutralWhite = Color.primary  // Adapts: black in light, white in dark
    ...
    static let backgroundPrimary = Color(.systemBackground)       // White in light, black in dark
    static let backgroundSecondary = Color(.secondarySystemBackground) // Light gray in light, dark gray in dark
